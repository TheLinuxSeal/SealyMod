...
public class SealyHUDEditor extends Screen {
    ...
    private void reload() {
        ...
        for(int i = 0; i < this.localWidgetData.size(); ++i) {
            ...
            Checkbox checkbox = Checkbox.builder(SealyModLang.getAsComponent("sealymod.sealyhud.editor.widget.enableCheckbox"), this.font).onValueChange((cb, value) -> element.setEnabled(value)).pos(20, initialY+1).selected(element.isEnabled()).build();
            Button deleteBtn = Button.builder(SealyModLang.getAsComponent("sealymod.sealyhud.editor.widget.deleteButton"), (btn) -> {
            ...
            EditBox xInput = new EditBox(this.font, checkbox.getWidth()+22, initialY, (int)((intInputsWidth -2)*0.4F), 20, SealyModLang.getAsComponent("sealymod.sealyhud.editor.widget.xFormula"));
            xInput.setValue(element.getXFormula());
            EditBox yInput = new EditBox(this.font, (int)(checkbox.getWidth()+(intInputsWidth-2)*0.4F+24), initialY, (int)((intInputsWidth -2)*0.4F), 20, SealyModLang.getAsComponent("sealymod.sealyhud.editor.widget.yFormula"));
            yInput.setValue(element.getYFormula());
            EditBox textSizeInput = new EditBox(this.font, (int)(checkbox.getWidth()+(intInputsWidth-2)*0.8F+26), initialY, (int)((intInputsWidth -2)*0.2F), 20, SealyModLang.getAsComponent("sealymod.sealyhud.editor.widget.textSizeFormula"));
            ...
            EditBox textInput = new EditBox(this.font, 20, initialY + 22, fullWidth, 20, SealyModLang.getAsComponent("sealymod.sealyhud.editor.widget.textInput"));
