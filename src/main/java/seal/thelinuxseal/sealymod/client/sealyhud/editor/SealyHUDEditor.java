...
public class SealyHUDEditor extends Screen {
    ...
    void reload() {
        ...
        Button addNewBtn = Button.builder(SealyModLangManager.MAIN.getAsComponent("sealymod.sealyhud.editor.addWidgetButton"), (btn) -> {
            this.elements.add(new SealyHUDEditorElement(new SealyHUDElement("", "", "0.75", "", false), this));
            this.reload();
        }).bounds(20, this.height - 35, 100, 20).build();
        Button exitBtn = Button.builder(SealyModLangManager.MAIN.getAsComponent("sealymod.sealyhud.editor.exit"), (btn) -> this.minecraft.setScreenAndShow(this.parent)).bounds(this.width - 120, this.height - 35, 100, 20).build();
        Button saveBtn = Button.builder(SealyModLangManager.MAIN.getAsComponent("sealymod.sealyhud.editor.save"), (btn) -> this.applyAndSave()).bounds(this.width - 230, this.height - 35, 100, 20).build();
        Button helpBtn = Button.builder(SealyModLangManager.MAIN.getAsComponent("sealymod.sealyhud.editor.help"), (btn) -> this.minecraft.setScreenAndShow(new SealyHUDEditorHelpScreen(this))).bounds(this.width - 340, this.height - 35, 100, 20).build();
