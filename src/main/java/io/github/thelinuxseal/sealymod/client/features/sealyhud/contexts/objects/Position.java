...
public final class Position {
    ...
    @ContextFunc(path = "Position().exactXYZ()", name = "Exact XYZ Coords", desc = "Returns the exact x, y, and z coordinates, separated by ', '", returns = "String")
    public String exactXYZ(){
        return  String.format("%s, %s, %s", exactX(), exactY(), exactZ());
    }
    ...
    @ContextFunc(path = "Position().xyz()", name = "XYZ Coords", desc = "Returns the x, y, and z coordinates, rounded to the nearest hundredth, separated by ', '", returns = "String")
    public String xyz(){
        return  String.format("%s, %s, %s", x(), y(), z());
    }

    @ContextFunc(path = "Position().blockX()", name = "Block X", desc = "Returns the block x coordinate of the position.", returns = "int")
    public int blockX() { return blockPos.getX(); }
    @ContextFunc(path = "Position().blockY()", name = "Block Y", desc = "Returns the block y coordinate of the position.", returns = "int")
    public int blockY() { return blockPos.getY(); }
    @ContextFunc(path = "Position().blockZ()", name = "Block Z", desc = "Returns the block z coordinate of the position.", returns = "int")
    public int blockZ() { return blockPos.getZ(); }
    @ContextFunc(path = "Position().blockXYZ()", name = "Block XYZ Coords", desc = "Returns the block x, y, and z coordinates, separated by ', '", returns = "String")
    public String blockXYZ(){
        return  String.format("%s, %s, %s", blockX(), blockY(), blockZ());
    }
